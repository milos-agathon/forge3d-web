...
test("Safari publication requires the complete independently bound SAF-02 proof", () => {
  ...
  const mutations = [
    ...
    [(value) => { delete safari(value).saf02Route; }, /same exact authorized route/u],
    [(value) => { safari(value).saf02Route.applicationUrl = "https://mac-m2.webgpu-ci.forge3d.dev/runs/999/888/cccccccccccccccccccccccccccccccc/"; }, /same exact authorized route/u],
