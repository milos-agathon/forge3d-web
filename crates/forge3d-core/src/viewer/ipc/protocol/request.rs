...
pub enum IpcRequest {
    ...
    SetTransform { #[serde(default)] translation: Option<[f32; 3]>, #[serde(default)] rotation_quat: Option<[f32; 4]>, #[serde(default)] scale: Option<[f32; 3]> },
    CamLookat { eye: [f32; 3], target: [f32; 3], #[serde(default = "default_up")] up: [f32; 3] },
    SetFov { deg: f32 },
